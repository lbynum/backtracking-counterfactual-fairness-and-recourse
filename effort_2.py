...
filename = f"results/effort_s2a_{','.join(opportunity_set)},n={dataset_size},nS={num_backtracking_samples},nL={num_loss_function_samples}"
...
filename = f"results/effort_s2a_group_{','.join(opportunity_set)},n={dataset_size},nS={num_backtracking_samples},nL={num_loss_function_samples}"
