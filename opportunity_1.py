...
models_to_test = [
    ...
    ('$X_1$', LinearRegression(), ['X_1']),
    ('$X_2$', LinearRegression(), ['X_2']),
    ("$X_1, X_2$", LinearRegression(), ['X_1', 'X_2']),
    ('$X_1, Z_A$', LinearRegression(), ['X_1', 'Z_A']),
...
filename = f"results/opportunity_s1_{','.join(opportunity_set)},n={dataset_size},nS={num_backtracking_samples},nL={num_loss_function_samples}"
